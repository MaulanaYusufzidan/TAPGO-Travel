...
<div class="container" style="max-width: 640px;">
    <div class="booking-card">
        ...
        @if($payment->status === 'paid')
            <div class="alert alert-success small mb-0">Pembayaran berhasil. <a href="{{ route('flight-bookings.confirmation', $booking) }}">Lihat konfirmasi booking</a>.</div>
        @else
            ...
            @unless(app()->environment('production'))
                ...
                <form method="POST" action="{{ route('flight-bookings.payment.simulate', $booking) }}" class="d-inline">
                    @csrf
